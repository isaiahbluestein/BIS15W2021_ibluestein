...
```
## [1] "/Users/isaiahbluestein/Desktop/BIS15W2021_ibluestein/lab2"
```
...
3. How do you interpret this result? What does this mean about NAs?  
 NAs invalidate some functions, such as calculating means. 
...
## [1] 5.888889
```
na.rm=T is useful because it allows you to ignore NA values and still use function to work with your data. 
